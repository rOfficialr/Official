        ...
        <div class="you fl">
            ...
            <div class="orderList">
                <div class="orderList1"><h3>待收货</h3>
                    <div class="clearfix"><a href="#" class="fl"><img style="width: 100px;height: 100px" src="images/product/${order_u.order_pfilename}"/></a>
                        <p class="fl"><a href="#">${order_u.order_pname}</a><a href="#">¥${order_u.order_price}×${order_u.order_quantity}</a></p></div>
                </div>
                ...
                <div class="orderList1 hei"><h3><strong>商品总价：</strong><span>¥${order_u.order_price * order_u.order_quantity}</span></h3>
