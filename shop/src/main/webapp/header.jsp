...
<div class="head">
    <div class="wrapper clearfix">
        <div class="clearfix" id="top"><h1 class="fl"><a href="index.html"><img src="img/temp/logoxike.png" style="width: 40%;height:40%"/></a></h1>
            ...
            <%--isLogin !=1 表示已经登陆--%>
            	...
            	<c:if test="${isAdminLogin ==2 }">
                    <i>管理员：</i><b>${name.user_name }</b><a href="manage/admin_index.jsp" style="color: #1f6377;"  id="login1">进入后台</a>
            	</c:if>
