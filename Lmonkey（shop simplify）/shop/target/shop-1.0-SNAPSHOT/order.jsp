            ...
            <div class="orderL fl"><!--------h3----------------><h3>收件信息<a href="#" class="fr">新增地址</a></h3>
                ...
                <div class="addres clearfix">
                    <div class="addre fl on">
                        <div class="tit clearfix"><p class="fl">${name.user_name} <span class="default">[默认地址]</span>
                        </p>
                ...
                <div class="dis clearfix"><span
                        class="on">顺风快递</span><span>百世汇通</span><span>圆通快递</span><span>中通快递</span>
                </div>
            </div>
            <div class="orderR fr">
                ...
                <!--<input type="button" name="" value="去支付">--> <a href="/paymentOk" class="pay">去支付</a></div>
        </div>
    </div><!--编辑弹框--><!--遮罩-->
    <div class="mask"></div>
