...
<%--                        <li><a href="remima.html">修改密码</a></li>--%>
            ...
            <div class="you fl">
                <div class="my clearfix"><h2 class="fl">我的订单</h2>
                ...
                <c:forEach var="rs" items="${requestScope.orderlist }">
                    <div class="dkuang clearfix deng"><p class="one fl">待收货</p>
                        ...
                        <div class="shohou clearfix"><a href="#" class="fl"><img
                            ...
                            <p class="fr"><button class="sure" style=" background-color:#b91616;width: 118px;height: 28px;line-height: 28px;text-align: center; color: #d6cccc;">确认收货</button><a href="orderxq?id=${rs.order_id}">订单详情</a></p></div>
...
<script>
    ...
    btn.addEventListener('click',function () {
        console.log('123')
        btn.style.backgroundColor='#3f3a3a'
        btn.disabled=true;
    })
</script>
</html>